/*============================== JOIN ISLEMLERI ===============================
    ...
    Union, Union All Operatorleri ayni/farkli tablolardaki sutunlari 
...
-- SELECT sadece okuma/filtreleme yapiyor. Kalici sonuclar dogurmuyor
...
------------------------------------------------------------------------------*/
	...
	SELECT sirket.sirket_id, sirket.sirket_isim, siparisler.siparis_id, siparis_tarihi
...
-- ilgili sutunlar listenir. kesisim kumesinin farkli tablolardaki elemanlarini birlestiriyor.
...
------------------------------------------------------------------------------*/
    ...
    ON sirket.sirket_id = siparisler.sirket_id;
        -- sirket tablomdaki tum sirketleri sirket tablosunda gorebildigim icin onu sola yazdim.
...
------------------------------------------------------------------------------*/   
    ...
    SELECT  siparisler.siparis_id, siparisler.siparis_tarihi, sirket.sirket_id, sirket.sirket_isim
...
------------------------------------------------------------------------------*/    
  ...
  NOT: bolum olmasa bile calisan ismi gosterilmelidir.
------------------------------------------------------------------------------*/
